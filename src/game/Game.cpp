...
Game::Game()
    : m_window(sf::VideoMode({1920, 1080}), "SoundFugue"), m_view({Constants::Window::ViewCenterX, Constants::Window::ViewCenterY}, {Constants::Window::Width, Constants::Window::Height}),
      m_world(m_window) {}
